...
func (s *IlmStore) GetBundlePath(repository string, reference string) (string, error) {
	var bundlePath string

	err := s.withLock(func(st *ImageLayerState) error {
...
func (s *IlmStore) GetConfigPath(repository string, reference string) (string, error) {
...
func (s *IlmStore) GetRootfsPath(repository string, reference string) (string, error) {
